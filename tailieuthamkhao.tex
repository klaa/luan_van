...
\begin{thebibliography}{99}
	...
	\bibitem{resnet_disadvantage} Cedric Okinda, Innocent Nyalala, Tchalla Korohou, Celestine Okinda, Jintao Wang, Tracy Achieng, Patrick Wamalwa, Tai Mang, Mingxia Shen {\it A review on computer vision systems in monitoring of poultry: A welfare perspective}, Artificial Intelligence in Agriculture - Volume 4 - Pages 184-208, 2020
	
	\bibitem{densenet_disadvantage} Wenqi Liu, Kun Zeng {\it SparseNet: A Sparse DenseNet for Image Classification}, arXiv:1804.05340 (\href{https://arxiv.org/pdf/1804.05340.pdf}{PDF}), 2018  
\end{thebibliography}
