...
\usepackage{amssymb,latexsym,amscd,amsmath,amsfonts,enumerate,supertabular}
...
%\newtheorem{example1}{Ví dụ}[chapter]
%\newtheorem{example2}{ Ví dụ}[chapter]
%\newenvironment{example}{\begin{example1}}{\end{example1}}
\newtheorem{prof}{}
